...
public class Profile {
    ...
    static Profile[] profiles = {
            new Profile("Lan Cao & Gregor Siedl",
                    ...
                    "After years of living oversea, when i came back to Hanoi, gradually i see Hanoi with different eyes, i would say before i wouldn't treasure all those dodgy colors of Hanoi and now i find beauty in many corners which before i would ignore.",
                    R.mipmap.test_char,
                    R.drawable.china,
                    R.raw.no0),
    ...
    private Profile(String name, String tag, String description, String itemDescription, int profileImagePath, int itemImagePath, int audioPath) {
        this.name = name;
